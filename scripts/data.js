...
const data = {
  items: [
    ...
    },
    {
      ...
      url: "https://catalog.jmu.edu/preview_course_nopop.php?catoid=50&coid=257204",
      desc: "Introduction to the design and implementation of modern operating systems. Explores fundamental concepts of operating systems, memory management, virtualization, resource allocation, file systems and system protection mechanisms. Course work includes a significant programming component.",
      prereqs: [361],
      credits: 3,
    },
  ],
